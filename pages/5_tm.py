...
#                       width=650, height=480).generate_from_frequencies(wc)
#     fig = plt.figure()
...
file_paths = ['./data/trump_ko.txt', './data/stevejobs_ko.txt']

selected_file = st.selectbox('워드클라우드 할 텍스트를 선택하세요', file_paths)
